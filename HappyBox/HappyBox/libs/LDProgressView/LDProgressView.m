...
//    else {
//        UIColor *baseLabelColor = [self.background isLighterColor] ? [UIColor blackColor] : [UIColor whiteColor];
//        label.textColor = [baseLabelColor colorWithAlphaComponent:0.6];
//        [label drawTextInRect:CGRectMake(40, 0, rect.size.width-12, rect.size.height)];
//    }
}
